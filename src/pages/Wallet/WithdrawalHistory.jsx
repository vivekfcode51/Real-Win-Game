            ...
            <div>
                <div className="hide-scrollbar overflow-x-auto py-3 mx-3">
                    <div className="flex gap-2 text-xsm font-bold">
                        ...
                        <div
                            className={`w-32 py-3 flex-col flex-shrink-0 flex items-center justify-between shadow-lg rounded-lg ${activeModal === 1 ? "bg-gradient-to-l from-[#ff9a8e] to-[#f95959] text-white" : "bg-white text-gray"
                                }  px-3 cursor-pointer`}
