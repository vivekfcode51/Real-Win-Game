...
function LotteryBetModalTrx({ gameHistoryData, profileDetails, myHistory, bet_api, onClose, gameDetails }) {
    ...
    const wingoBetHandler = async () => {
        ...
        if (checkAgreement) {
            try {
                ...
                console.log("bet_apibet_apibet_apibet_api",bet_api, res)
...
export default LotteryBetModalTrx;
