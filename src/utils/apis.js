...
export const baseUrlUsaWin = "https://real-win.globalbet786.live";
...
const apis = {
  ...
  payin_deposit_usdt: `${configModalUsaWin}payin/usdt`,
  payin_deposit_usdt_qr: `${configModalUsaWin}get-usdt-qrcode`,
  manual_payin: `${configModalUsaWin}manual_payin`,
